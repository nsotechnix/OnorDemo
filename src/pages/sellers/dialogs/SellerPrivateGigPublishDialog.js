                            ...
                            <Row>
                                <Col className="mycol">
                                    <Card className="p-2 h-100">
                                        <Form.Group className="mycol mt-4" controlId="formBasicEmail">
                                            <Form.Control className="mycol" type="text" placeholder="Description" />
                                        </Form.Group>
                                ...
                                <Col className="mycol">
                                    <Card className="p-2">
                                        <Card.Title className="mycol"><h3 style={{
                                            color: "orangered"
                                        }}>Seller details</h3></Card.Title>
                                        <Card.Body style={{
                                    ...
                                    <Card onClick={e => {
                                        ...
                                        <Card.Body style={{
                                            ...
                                            <div className="mycol row d-flex justify-content-between my-3">
                                                <h6 className="mycol col-6" style={{
                                                    color: "orangered"
                                                }}>Buy</h6>
                                ...
                                <Col className="mycol">
                                    <Card className="p-2 h-100">
                                        ...
                                        <Card.Body style={{
                                            ...
                                            <Form.Group className="mycol" controlId="exampleForm.ControlTextarea1">
                                                <Form.Control placeholder="Post your review here" className="mycol" as="textarea" rows="4" />
                                            </Form.Group>
                                        </Card.Body>
                                    </Card>
                                </Col>
